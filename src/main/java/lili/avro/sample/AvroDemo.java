...
public class AvroDemo {
    public static void main(String args[]) {
        ...
        try {
            dataFileWriter.create(user1.getSchema(), new File("users.avro")); // run is ok.
//            dataFileWriter.create(user2.getSchema(),file);  //same to the front line
